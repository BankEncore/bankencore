...
# Backfill broad allowed types for missing codes
defaults = {
  "accountant_for" => [ %w[person organization], %w[person organization] ],
  "has_accountant" => [ %w[person organization], %w[person organization] ],
  "advised_by" => [ %w[person organization], %w[person organization] ],
  "advisor_of" => [ %w[person organization], %w[person organization] ],
  "beneficiary_of" => [ %w[person organization], %w[person organization] ],
  "has_beneficiary" => [ %w[person organization], %w[person organization] ],
  "trustee_of" => [ %w[person organization], %w[person organization] ],
  "has_trustee" => [ %w[person organization], %w[person organization] ],
  "protector_of" => [ %w[person organization], %w[person organization] ],
  "has_protector" => [ %w[person organization], %w[person organization] ],
  "settlor_of" => [ %w[person organization], %w[person organization] ],
  "has_settlor" => [ %w[person organization], %w[person organization] ],
  "co_borrower_of" => [ %w[person organization], %w[person organization] ], # symmetric
  "co_signer_of" => [ %w[person organization], %w[person organization] ],
  "has_co_signer" => [ %w[person organization], %w[person organization] ],
  "control_person_of" => [ %w[person], %w[organization] ],
  "has_control_person" => [ %w[organization], %w[person] ],
  "franchisee_of" => [ %w[organization], %w[organization] ],
  "franchisor_of" => [ %w[organization], %w[organization] ],
  "related_party_of" => [ %w[person organization], %w[person organization] ] # symmetric
}

defaults.each do |code, (from, to)|
  r = Ref::PartyLinkType.find_or_initialize_by(code: code)
  r.name ||= code.humanize
  # set symmetry and inverses where known
  if code == "co_borrower_of" || code == "related_party_of"
    r.symmetric = true
    r.inverse_code = nil
  else
    r.symmetric = false if r.symmetric.nil?
    r.inverse_code ||= {
      "accountant_for"=>"has_accountant", "advised_by"=>"advisor_of", "advisor_of"=>"advised_by",
      "beneficiary_of"=>"has_beneficiary", "trustee_of"=>"has_trustee", "protector_of"=>"has_protector",
      "settlor_of"=>"has_settlor", "co_signer_of"=>"has_co_signer", "control_person_of"=>"has_control_person",
      "franchisee_of"=>"franchisor_of", "franchisor_of"=>"franchisee_of"
    }[code]
  end
  r.allowed_from_party_types = from if r.allowed_from_party_types.blank?
  r.allowed_to_party_types   = to   if r.allowed_to_party_types.blank?
  r.save!
end
